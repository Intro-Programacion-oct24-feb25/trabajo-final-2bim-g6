...
public class trabajoFinal {
    ...
    public static void main(String[] args) {
        ...
        while (bandera) {
            ...
            switch (opcion) {
                case 1:
                    cadena= funcion01(cadena);
                    resultados[0]++;
                    totalActividades++;
                    break;
                case 2:
                    cadena =funcion02(cadena);
                    resultados[1]++;
                    totalActividades++;
                    break;
                case 3:
                    cadena = funcion03(cadena);
                    resultados[2]++;
                    totalActividades++;
                    break;
                case 4:
                    cadena = funcion04(cadena);
                    resultados[3]++;
                    totalActividades++;
                    break;
                case 5:
                     cadena = funcion05(cadena);
                    resultados[4]++;
                    totalActividades++;
                    break;
                case 6:
                    cadena = funcion06(cadena);
                    resultados[5]++;
                    totalActividades++;
                    break;
                case 7:
                    cadena = funcion07(cadena);
                    resultados[6]++;
                    totalActividades++;
                    break;
                default:
